#Hangman Project playing with the programmer done by Shiraz Waseem ( CT-066 ) , Dawood Mehmood ( CT-065 ) , Anas Bin Azim ( CT-090 ).
print("You are accused of choosing BCIT as your career:/\nYou have a chance to save your life!\nGuess the word in given turns \
...
print()
f=open('words.txt')       #You have to create the words.txt file first in your python project file.
#Now add words in "small alphabetic characters" in your words file which you want to play with the programmer
a=f.read()
f.close()
answer_list=a.split( )
import random
